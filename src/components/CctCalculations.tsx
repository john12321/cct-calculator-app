...
export const CctCalculations: FC = () => {
  ...
  const handleCalculate = async () => {
    ...
    const calculationBaseDate = getCalculationBaseDate(
      programmeEndDate,
      calculationChanges,
      editingIndex
    );
    ...
    const daysAdded = draftCalculation?.endWte
      ? calculateLtftExtensionDays(changeDaySpan, draftCalculation.endWte / 100)
      : calculateAbsenceExtensionDays(changeDaySpan);
